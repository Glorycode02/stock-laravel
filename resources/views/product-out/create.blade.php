...
<a href="{{ route('product-out.index') }}" class="p-2 bg-gray-800 rounded-md text-white">Back to Product Out List</a>
<div class="flex justify-center">
    ...
    <form action="{{ route('product-out.store') }}" method="POST" class="border border-slate-600 w-1/2 mt-5 p-5 shadow-xl rounded-md flex flex-col gap-4">
        ...
        <button type="submit" class="bg-gray-900 p-4 w-full rounded-md text-white">Record Product Out</button>
    </form>
